...
gearItems := ["Watering Can", "Trowel", "Recall Wrench", "Basic Sprinkler", "Advanced Sprinkler"
             , "Medium Toy", "Medium Treat", "Godly Sprinkler", "Magnifying Glass", "Tanning Mirror", "Master Sprinkler", "Cleaning Spray", "Favorite Tool", "Harvest Tool", "Friendship Pot", "Levelup Lollipop"]

eggItems := ["EGG'S DONT WORK RIGHT NOW"]
...
ShowGui:
    ...
    Gui, Add, Tab, x10 y10 w580 h440 vMyTab, Seeds|Gears|Eggs|Cosmetics|Settings|Support/Copyright
...
Gui, Add, Edit, x180 y165 w40 h18 Limit1 vSavedKeybind gUpdateKeybind, %SavedKeybind%
   ...
   Gui, Tab, 6
    ...
    Gui, Add, Picture, x40 y70 w48 h48, % mainDir "Images\\Kitty.png"
    Gui, Font, s10 cWhite Bold, Segoe UI
    Gui, Add, Text, x100 y70 w200 h24, LILmonster9285
    Gui, Font, s8 cFFC0CB Italic, Segoe UI
    Gui, Add, Text, x100 y96 w200 h16, LILmonster9285
    Gui, Font, s8 cWhite, Segoe UI
    Gui, Add, Text, x40 y130 w200 h40, This is a Free Version Of The Premium Macro For Virage And this version  is better

    Gui, Add, Picture, x240 y70 w50 h50, % mainDir "Images\\Kitty.png"
    Gui, Font, s10 cWhite Bold, Segoe UI
    Gui, Add, Text, x300 y70 w180 h24, LILmonster9285
    Gui, Font, s8 cWhite, Segoe UI
    Gui, Add, Text, x300 y96 w180 h40, This is a Free Version Of The Premium Macro For Virage And this version  is better

    Gui, Font, s9 cWhite Bold, Segoe UI
    Gui, Add, Text, x40 y274 w200 h20, Extra Resources:
    Gui, Font, s8 cD3D3D3 Underline, Segoe UI
     Gui, Add, Link, x40 y294 w300 h16, Join the <a href="https://discord.gg/rJteVpPB">LILmonster9285 Discord Server</a>!
	 Gui, Add, Link, x40 y314 w300 h16, Join the <a href="https://discord.com/invite/BPPSAG8MN5"> Virage Discord Server</a>!
    Gui, Add, Text, x40 y334 w300 h16, Credits To Virage For The Macro.
    ...
    Gui, Show, w520 h460, LILmonster9285 Macro [Free/Free]
